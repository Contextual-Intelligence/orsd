...
ORSD aggregates regulatory signals from the following public data sources.
Each source retains its own license for the individual data; the database
compilation is licensed under ODbL v1.0.
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for the process to add a new data source.
